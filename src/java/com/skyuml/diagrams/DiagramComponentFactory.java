...
public class DiagramComponentFactory {
    ...
    public static DiagramComponentOperation createComponent(JSONObject diagramContent) throws JSONException{
    ...
    private static DiagramComponentOperation createClass(JSONObject diagramContent) throws JSONException{
        ...
        return new com.skyuml.diagrams.classdiagram.component.Class(id, title, x, y, meth, mem);
    }
